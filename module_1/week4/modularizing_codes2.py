...
''' Let's make the scope of the implementation broader and interactive
    Let's have our project structure
    library_project2/
    |
    |-- data/
    |   |-- data.py
...
#data/data.py   -   This will handle data storage in jscon format
import json 
import os 
...
def load_books():
    """Load books from JSON file if it exist"""
    global books 
...
# manin.py      - This will initialize by loading books at startup
from data import data
from utils import helpers
from services import library
