...
#             For undergraduate courses, applicants usually need five distinctions (As and Bs) in relevant subjects in their WAEC/WASSCE (May/June) exams, including English and Mathematcis.
# '''
# name = input("Enter your name: ")       # This prompts the user to input their name
# age = int(input("Enger your age: "))    # This prompts the user for their age
